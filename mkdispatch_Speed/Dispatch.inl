void TestDispatch(int count) {
	...
	for(int i = 0; i < count; ++i) {
		Dispatch("POST /extensions/clientId/auth/secret\r", nullptr, next, nullptr, socket);
		Dispatch("GET /extensions/clientId/auth/secret\r", nullptr, next, nullptr, socket);
		Dispatch("DELETE /extensions/clientId/auth/secret\r", nullptr, next, nullptr, socket);
		Dispatch("GET /extensions/clientId/live_activated_channels\r", nullptr, next, nullptr, socket);
		Dispatch("PUT /extensions/clientId/version/required_configuration\r", nullptr, next, nullptr, socket);
		Dispatch("PUT /extensions/clientId/configurations\r", nullptr, next, nullptr, socket);
		Dispatch("GET /extensions/clientId/configurations/channels/channelId\r", nullptr, next, nullptr, socket);
		Dispatch("GET /extensions/clientId/configurations/segments/broadcaster\r", nullptr, next, nullptr, socket);
		Dispatch("GET /extensions/clientId/configurations/segments/developer\r", nullptr, next, nullptr, socket);
		Dispatch("GET /extensions/clientId/configurations/segments/global\r", nullptr, next, nullptr, socket);
		Dispatch("POST /extensions/message/channelId\r", nullptr, next, nullptr, socket);
		Dispatch("POST /extensions/message/all\r", nullptr, next, nullptr, socket);
		Dispatch("POST /extensions/clientId/version/channels/channelId/chat\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/analytics/extensions\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/analytics/games\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/bits/leaderboard\r", nullptr, next, nullptr, socket);
		Dispatch("POST /helix/clips\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/clips\r", nullptr, next, nullptr, socket);
		Dispatch("POST /helix/entitlements/upload\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/entitlements/codes\r", nullptr, next, nullptr, socket);
		Dispatch("POST /helix/entitlements/codes\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/games/top\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/games\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/streams\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/streams/metadata\r", nullptr, next, nullptr, socket);
		Dispatch("POST /helix/streams/markers\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/streams/markers\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/users\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/users/follows\r", nullptr, next, nullptr, socket);
		Dispatch("PUT /helix/users\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/users/extensions/list\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/users/extensions\r", nullptr, next, nullptr, socket);
		Dispatch("PUT /helix/users/extensions\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/videos\r", nullptr, next, nullptr, socket);
		Dispatch("GET /helix/webhooks/subscriptions\r", nullptr, next, nullptr, socket);
	}
