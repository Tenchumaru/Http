void TestDispatch(int count) {
	...
	for(int i = 0; i < count; ++i) {
		Dispatch("POST /extensions/clientId/auth/secret\r", response);
		Dispatch("GET /extensions/clientId/auth/secret\r", response);
		Dispatch("DELETE /extensions/clientId/auth/secret\r", response);
		Dispatch("GET /extensions/clientId/live_activated_channels\r", response);
		Dispatch("PUT /extensions/clientId/version/required_configuration\r", response);
		Dispatch("PUT /extensions/clientId/configurations\r", response);
		Dispatch("GET /extensions/clientId/configurations/channels/channelId\r", response);
		Dispatch("GET /extensions/clientId/configurations/segments/broadcaster\r", response);
		Dispatch("GET /extensions/clientId/configurations/segments/developer\r", response);
		Dispatch("GET /extensions/clientId/configurations/segments/global\r", response);
		Dispatch("POST /extensions/message/channelId\r", response);
		Dispatch("POST /extensions/message/all\r", response);
		Dispatch("POST /extensions/clientId/version/channels/channelId/chat\r", response);
		Dispatch("GET /helix/analytics/extensions\r", response);
		Dispatch("GET /helix/analytics/games\r", response);
		Dispatch("GET /helix/bits/leaderboard\r", response);
		Dispatch("POST /helix/clips\r", response);
		Dispatch("GET /helix/clips\r", response);
		Dispatch("POST /helix/entitlements/upload\r", response);
		Dispatch("GET /helix/entitlements/codes\r", response);
		Dispatch("POST /helix/entitlements/codes\r", response);
		Dispatch("GET /helix/games/top\r", response);
		Dispatch("GET /helix/games\r", response);
		Dispatch("GET /helix/streams\r", response);
		Dispatch("GET /helix/streams/metadata\r", response);
		Dispatch("POST /helix/streams/markers\r", response);
		Dispatch("GET /helix/streams/markers\r", response);
		Dispatch("GET /helix/users\r", response);
		Dispatch("GET /helix/users/follows\r", response);
		Dispatch("PUT /helix/users\r", response);
		Dispatch("GET /helix/users/extensions/list\r", response);
		Dispatch("GET /helix/users/extensions\r", response);
		Dispatch("PUT /helix/users/extensions\r", response);
		Dispatch("GET /helix/videos\r", response);
		Dispatch("GET /helix/webhooks/subscriptions\r", response);
	}
